...
public sealed class PostPlaySummaryRenderer
{
    ...
    public void Draw(SpriteBatch spriteBatch, PlayState play, MatchState match, float timeSeconds)
    {
        ...
        // Panel.
        var panel = new Rectangle(24, 48, UiScaling.BaseWidth - 48, 128);
        ...
        var yardsPos = new Vector2(panel.X + 12, panel.Y + 54);
        ...
        var ddPos = new Vector2(panel.X + 12, panel.Y + 82);
        ...
        {
            var promptPos = new Vector2(panel.X + 12, panel.Bottom - 22);
